        ...
        <div>
            <div>
                <div class="login">
                    ...
                    <form action="{{ route('website.doregister') }}" class="login__form" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <h1 class="login__title text-light">Register</h1>
                        ...
                        <div class="login__content">
                            <div class="login__box">
                                ...
                                <div class="login__box-input">
                                    <input class="login__input" id="username" name="name" placeholder=" ">
                                    <label for="login-email" class="login__label text-light">Full Name</label>
                                </div>
                            </div>
                            <div class="login__box">
                                {{-- <i class="ri-file-user-line"></i> --}}
                                <i class="ri-file-user-line login__icon text-light"></i>

                                <div class="login__box-input">
                                    <input class="login__input" id="username" name="username" placeholder=" ">
                                    <label for="login-email" class="login__label text-light">UserName</label>
                                </div>
                            </div>
                            ...
                            <div class="login__box">
                                <i class="ri-smartphone-line login__icon text-light"></i>

                                <div class="login__box-input">
                                    <input  required class="login__input" id="password" name="phone"
                                        placeholder=" ">
                                    <label for="login-pass" class="login__label text-light">Phone</label>
                                    {{-- <i class="fa-thin fa-phone"></i> --}}
                                </div>
                            </div>
                            <div class="login__box">
                                {{-- <i class="ri-mail-line"></i> --}}
                                <i class="ri-mail-line login__icon text-light"></i>

                                <div class="login__box-input">
                                    <input class="login__input" id="username" name="email" placeholder=" ">
                            ...
                            <div class="login__box">
                                ...
                                <div class="login__box-input">
                                    {{-- <input   class="login__input" id="username" name="email"
                                    placeholder=" ">
                                <label for="login-email" class="login__label text-light">Email</label> --}}
                                    <label class="login__label text-light">Gender</label>
                            ...
                            <div class="login__box">
                                ...
                                <div class="login__box-input">
                                    <input type="file" class="login__input" id="username" name="image" placeholder=" ">
                                    <label for="login-email" class="login__label text-light">Image</label>
                                </div>
                            </div>
                        ...
                        <p class="login__register text-light">
                           You have account? <a class="text-decoration-none"href="login ">Login</a>
                        </p>
                    </form>
