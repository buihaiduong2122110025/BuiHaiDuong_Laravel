                    ...
                    <table class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center bg-dark"style="width:300px">Tiêu đề bài viết</th>
                                <th class="text-center bg-dark">Chủ đề</th>
                                <th class="text-center bg-dark" style="width:100px">Kiểu</th>
