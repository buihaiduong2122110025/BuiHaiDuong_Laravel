                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item text-decoration-none"><a href="{{ route('admin.dashbroad.index') }}">Home</a></li>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center bg-dark" style="width:90px">Hình</th>
                                <th class="text-center  bg-dark" >Tên sản phẩm</th>
                                <th class="text-center  bg-dark">Danh mục</th>
                                <th class="text-center  bg-dark">Thương hiệu</th>
